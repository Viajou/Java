        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="alterar_plano.jsp?id=<%=busca.getInt("id")%>&descricao=<%=busca.getString("descricao")%>&livrePropaganda=<%=busca.getBoolean("livreDescricao")%>&nome=<%=busca.getString("nome")%>&preco=<%=busca.getDouble("preco")%>">
