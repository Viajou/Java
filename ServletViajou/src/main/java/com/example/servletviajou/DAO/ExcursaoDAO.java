...
// Método para leitura da tabela excursao
    public ResultSet buscar() {
        ...
        try{
            ...
            PreparedStatement pstmt = conn.prepareStatement("SELECT atracao.nome, * FROM excursao JOIN atracao ON atracao.id = excursao.id_atracao order by excursao.id");
...
//  Alterações na tabela excursao
    ...
    public int alterarPrecoTotal(int id, double preco_total) {
        // Instanciando os objetos
        Conexao conexao = new Conexao();
