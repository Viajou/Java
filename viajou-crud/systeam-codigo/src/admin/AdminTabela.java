...
public class AdminTabela {
    //Fazendo as variaveis de acordo com as colunas das tabela
    private int id;
    private String nome;
    ...
    // criando o metodo construtor para poder iniciar o objeto junto com as variaveis.
    public AdminTabela(String nome, String email, String senha, String url_imagem) {
        this.nome = nome;
        this.email = email;
        this.senha = senha;
